...
public class SalesOrderEntity  implements java.io.Serializable {
    ...
    private Magento.SalesOrderAddressEntity shipping_address;

    private Magento.SalesOrderAddressEntity billing_address;

    private Magento.SalesOrderItemEntity[] items;

    private Magento.SalesOrderPaymentEntity payment;

    private Magento.SalesOrderStatusHistoryEntity[] status_history;
    ...
    public SalesOrderEntity(
           ...
           Magento.SalesOrderAddressEntity shipping_address,
           Magento.SalesOrderAddressEntity billing_address,
           Magento.SalesOrderItemEntity[] items,
           Magento.SalesOrderPaymentEntity payment,
           Magento.SalesOrderStatusHistoryEntity[] status_history) {
     ...
     */
    public void setShipping_address(Magento.SalesOrderAddressEntity shipping_address) {
        this.shipping_address = shipping_address;
    }
     ...
     */
    public void setBilling_address(Magento.SalesOrderAddressEntity billing_address) {
        this.billing_address = billing_address;
    }
     ...
     * @return items
     */
    public Magento.SalesOrderItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(Magento.SalesOrderItemEntity[] items) {
        this.items = items;
    }
     ...
     * @param payment
     */
    public void setPayment(Magento.SalesOrderPaymentEntity payment) {
        this.payment = payment;
    }
     ...
     */
    public Magento.SalesOrderStatusHistoryEntity[] getStatus_history() {
        return status_history;
    }
     ...
     */
    public void setStatus_history(Magento.SalesOrderStatusHistoryEntity[] status_history) {
        this.status_history = status_history;
    }
