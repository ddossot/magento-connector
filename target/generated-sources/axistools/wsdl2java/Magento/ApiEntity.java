...
public class ApiEntity  implements java.io.Serializable {
    ...
    private Magento.ApiMethodEntity[] methods;
    ...
    public ApiEntity(
           ...
           Magento.ApiMethodEntity[] methods) {
           this.title = title;
           this.name = name;
     ...
     * @return methods
     */
    public Magento.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(Magento.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
