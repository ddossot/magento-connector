...
public class Filters  implements java.io.Serializable {
    private Magento.AssociativeEntity[] filter;

    private Magento.ComplexFilter[] complex_filter;

    public Filters() {
    }

    public Filters(
           Magento.AssociativeEntity[] filter,
           Magento.ComplexFilter[] complex_filter) {
           this.filter = filter;
     ...
     * @return filter
     */
    public Magento.AssociativeEntity[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(Magento.AssociativeEntity[] filter) {
        this.filter = filter;
    }
     ...
     */
    public Magento.ComplexFilter[] getComplex_filter() {
        return complex_filter;
    }
     ...
     */
    public void setComplex_filter(Magento.ComplexFilter[] complex_filter) {
        this.complex_filter = complex_filter;
    }
