...
public class SalesOrderShipmentEntity  implements java.io.Serializable {
    ...
    private Magento.SalesOrderShipmentItemEntity[] items;

    private Magento.SalesOrderShipmentTrackEntity[] tracks;

    private Magento.SalesOrderShipmentCommentEntity[] comments;
    ...
    public SalesOrderShipmentEntity(
           ...
           Magento.SalesOrderShipmentItemEntity[] items,
           Magento.SalesOrderShipmentTrackEntity[] tracks,
           Magento.SalesOrderShipmentCommentEntity[] comments) {
     ...
     * @return items
     */
    public Magento.SalesOrderShipmentItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(Magento.SalesOrderShipmentItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return tracks
     */
    public Magento.SalesOrderShipmentTrackEntity[] getTracks() {
        return tracks;
    }
     ...
     * @param tracks
     */
    public void setTracks(Magento.SalesOrderShipmentTrackEntity[] tracks) {
        this.tracks = tracks;
    }
     ...
     * @return comments
     */
    public Magento.SalesOrderShipmentCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(Magento.SalesOrderShipmentCommentEntity[] comments) {
        this.comments = comments;
    }
