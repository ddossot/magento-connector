...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private Magento.SalesOrderInvoiceItemEntity[] items;

    private Magento.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           Magento.SalesOrderInvoiceItemEntity[] items,
           Magento.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public Magento.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(Magento.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public Magento.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(Magento.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
